...
<form action="saveLog.jsp" method="post">
    <input type="hidden" name="id" value="<%=logInfo.getId()%>" />
    <input type="hidden" name="uId" value="<%=logInfo.getUserId()%>" />
	<table align="center" width="50%" cellpadding="5" cellspacing="1" style="background:none;">
	
	   <tr>
	      <td> 日志标题:</td><td><input name="title" type="text" size="40" value="<%=logInfo.getTitle()%>"/></td></tr>
	      <tr><td valign="top">日志内容:</td>
	      <td><textarea name="content" cols="40" rows="20"><%=logInfo.getContent()%></textarea></td>
	   </tr>
	   <tr align="center">
